...
class BottleneckBlock(nn.Module):
    ...
    def preprocess(self, x):
        ...
        #     x = x1 + x2
            ...
            assert False, f"Expected {x.shape[-1]} to be {self.emb_width}"
        return x, prenorm
...
class Bottleneck(nn.Module):
    def __init__(self,cfg):
        super().__init__()
        self.l_bins = cfg.trainer.codebook.nb_bins
        self.emb_channels = cfg.trainer.codebook.emb_channels
        self.mu = cfg.trainer.codebook.mu
