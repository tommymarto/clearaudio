...
from clearaudio.utils.utils import fix_random_seeds
from clearaudio.models.dummy_model import DummyModel
    ...
    def setup_trainer(self) -> None:
        ...
        if self.cfg.trainer.rank == 0:
            if self.cfg.trainer.use_clearml:
                ...
                task = Task.init(
                    project_name="ClearAudio", task_name=self.cfg.trainer.ml_exp_name
                )
